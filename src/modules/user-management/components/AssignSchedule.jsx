// src/modules/user-management/components/AssignSchedule.jsx - VERSIÓN CORREGIDA LAYOUT
...
const AssignSchedule = ({ onCancel }) => {
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      {/* Grid con anchos fijos */}
      <Grid container spacing={3}>
        {/* Panel izquierdo - Ancho fijo */}
                      ...
                      <>
                        {weeklySchedule[dia.clave].turno ? (
                          ...
                          <Box sx={{ textAlign: "center", py: 3, bgcolor: 'white', borderRadius: 2 }}>
                            ...
                            >
                              Seleccione un turno para este día
                            </Typography>
                            <Box
                              sx={{
                                display: "flex",
